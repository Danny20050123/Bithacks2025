...
const Tracks = () => {
  return (
    <div className="flex justify-center bg-[#B69BFB] h-[2400px] rounded-[15px] md:h-[1000px]" id = "tracks">
      <div className="invisble md:absolute opacity-100 top-[2000px] h-[400px] w-[600px] left-10 justify-left items-left invisible md:visible absolute opactiy-100 top-[2600px] h-[400px] w-[600px] left-0 justify-left items-left">
      ...
      <h1 className="relative flex text-center justify-center h-[100px] text-4xl top-[-50px]">Tracks</h1>
        <div className="relative flex flex-col top-[0px] gap-20 p-5 md:flex-row gap-20">
        <CardComponent title="Best Overall 🏆" content="Awarded to the most outstanding hack that excels in creativity, functionality, and impact." img="/best_overall.png" />
        <CardComponent title="Best Beginner 🚀" content="A special prize for first-time hackers who impress with their innovation and effort." img="/best_beginner.png" />
        <CardComponent title="Hacker’s Choice 🗳️" content="Voted by fellow participants, this hack wins the community’s seal of approval." img="/hackers_choice.png" />
        </div>

        <div className="relative flex flex-col justify-center top-[100px] gap-20 p-5 md:flex-row gap-20">
        <CardComponent title="Medtronic Track 💙" content="Sponsored by Medtronic, this prize goes to the best healthcare or medical innovation." img="/medtronic.png" />
        <CardComponent title="Meme Hack 😂" content="The funniest, most creative, and internet-worthy hack takes home this prize." img="/meme_hack.png" />
        </div>
      </div>
    </div>
  );
